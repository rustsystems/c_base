...
t_f = 10000;
% sample time (sec)
h   = 0.1;  % UUV simulations work at 1 Hz (may need to change this in future)
...
for i=1:n+1
    ...
    while nointersection || (ns < length(angle_list))
        ...
        if intersecting_lines(160.93,xs1,xs2,ys1,ys2,p_list(ns,1),p_list(ns+1,1),p_list(ns,2),p_list(ns+1,2))
